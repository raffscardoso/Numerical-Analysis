/****************** Usage: For finding the real roots of any given Bi-quadratic equation. ****************************/
...
/*************** Given Equation: x^4 - 26*x^2 + 49*x - 25 = 0 **************/
/*************** Roots are: 3.875793 & -5.915833 ***************/
...
int main(int argc, char **argv)
{
   ...
   a = atof(argv[1]);  //Coverrting arguments
...
float function(float val)
{
   ...
   fx = (x * x * x * x) - (26 * x * x) + (49 * x) - 25;  // Function Equation
